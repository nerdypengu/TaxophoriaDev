...
(($) => {
    ...
    class Window_KorNameInput extends Window_Command {
        ...
        updatePlacement() {
            ...
            for (let i = 0; i < this.maxItems(); i++) {
                width +=
                    this.textWidth(this._list[i].name) + this.textPadding() * 2;
            }
    ...
    class Scene_KorName extends Scene_Name {
        ...
        createHelpWindow() {
            ...
            rect.y =
                Graphics.boxHeight -
                Math.ceil(Graphics.boxHeight / 6) -
                this.helpAreaHeight();
        ...
        createCommandWindowRect() {
            ...
            if (!this._editWindow) {
                return new Rectangle(gw / 2 - w / 2, gh / 2 - h / 2, w, h);
            }
        ...
        createCommandWindow() {
            ...
            this._commandWindow.y =
                this._editWindow.y + this._editWindow.height;
